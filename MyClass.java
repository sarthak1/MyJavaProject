...
public class MyClass {
	...
	private static String[] tenToNinteen = { "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen",
			"seventeen", "eighteen", "nineteen" };

	private static String[] dozens = { "ten", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty",
			"ninety" };
	...
	public static void main(String[] args) {
		...
		System.out.println(Integer.MAX_VALUE+"----"+solution(Integer.MAX_VALUE));
